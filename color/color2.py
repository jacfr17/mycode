...
def main():
    ...
    # print 'Fred Jackson III' in magenta
    print(crayons.magenta('Fred Jackson III', bold=True))

    # print 'Fred Jackson III' in yellow
    print(crayons.yellow('Fred Jackson III', bold=True))
